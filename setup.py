...
setup(
    name="prepropy",
    version="0.1.0",    author="PreProPy Team",
    author_email="example@example.com",
    description="A comprehensive data preprocessing toolkit combining NullSense for missing values, DupliChecker for duplicates, and ScaleNPipe for ML pipelines",
